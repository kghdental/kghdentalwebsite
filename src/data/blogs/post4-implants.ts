...
export const post4Implants: BlogPost = {
  id: "blog-4",
  slug: "dental-implants-101-candidate-guide",
  title: {
    en: "Dental Implants 101: The Gold Standard for Permanent Tooth Replacement",
    bn: "ডেন্টাল ইমপ্ল্যান্ট এ টু জেড: হারিয়ে যাওয়া দাঁত স্থায়ীভাবে প্রতিস্থাপনের বিশ্বমানের সমাধান",
  },
  excerpt: {
    en: "Discover why dental implants are considered the pinnacle of restorative dentistry. Learn about osseointegration, bone density requirements, sinus lifts, and how implants protect your jaw structure.",
    bn: "হারানো দাঁতের জায়গায় ডেন্টাল ইমপ্ল্যান্ট কেন আধুনিক চিকিৎসায় সেরা সমাধান? টাইটানিয়াম রুট, চোয়ালের হাড়ের পুনর্গঠন এবং আজীবন টেকসই হাসির সম্পূর্ণ গাইড।",
  },
  departmentSlug: "prosthodontics",
  departmentName: {
    en: "Prosthodontics",
    bn: "প্রস্থোডন্টিক্স",
  },
  readTime: "9 min read",
  date: "Sep 2026",
  targetKeyword: "dental implants dhaka permanent tooth replacement prosthodontist osseointegration",
  coverImage: "/images/sub_services/2.3. Dental Implant Surgery.png",
  authorName: {
    en: "Admin",
    bn: "এডমিন",
  },
  ...
  authorPhotoUrl: "",
  tags: ["dental implants", "prosthodontics", "missing teeth", "zirconia crown", "kgh dental"],
  contentHtml: {
    en: `
